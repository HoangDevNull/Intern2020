...
function ArticleList({ articles, onPageChange, page }) {
    ...
    return (
        <>
                ...
                renderItem={item => (
                    ...
                    >
                        <List.Item.Meta
                            ...
                            title={<a className="font-md" href="https://ant.design">{item.author.username}</a>}
            ...
            <div className="paginate-wrapper">
                <Pagination current={page} showSizeChanger={false} showTotal={total => `Total ${total} items`} onChange={onPageChange} total={articles.articlesCount} />
            </div>
